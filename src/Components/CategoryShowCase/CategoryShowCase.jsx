...
setItems(ProductData.filter(p => p.cate === term))
}
return (
<div className="course-section padding-tb style-3">
...
<div className="section-wrapper">
    <div className="row g-4 justify-content-center row-cols-xl-4 r row-cols-lg-3 row-cols-md-2 row-cols-1 course-filter">
        {
            items.map((item,index) => (
                <div className="col pointer" key={item.id}>
