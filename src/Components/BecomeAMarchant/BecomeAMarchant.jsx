...
const BecomeAMarchant = () => {
return (
<div className="instructor-section style-2 padding-tb section-bg-ash">
<div className="container">
<div className="section-wrapper">
<div className="row g-4 align-items-center justify-content-center row-cols-1 row-cols-md-2 row-cols-lg-3">
<div className="col">
{
countList.map(item => (
    <div key={item.iconName} className="count-item">
...
export default BecomeAMarchant