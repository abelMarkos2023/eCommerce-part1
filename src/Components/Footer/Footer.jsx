...
<div className="row g-4 justify-content-center align-items-start row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
<div className="col">
...
<div className="footer-bottom">
    <div className="container">
        <div className="section-wrapper">
            <p>&copy; 2024 <Link to = '/'>Shop Cart</Link> Designed By <a href="#">Abel Markos</a></p>
            <div className="footer-bottom-list">
                {
                    footerbottomList.map(iten => (
                        <a href="#" key={iten.text}>{iten.text}</a>
                    ))
                }
            </div>
        </div>
