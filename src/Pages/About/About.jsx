...
const About = () => {
  return (
    <div>
        <PageHeader title={`About Page`} currentPage={' about'} />
        <div className="about-section padding-tb style-3 section-bg">
            <div className="container">
                <div className="row row-cols-xl-2 row-cols-1 justify-content-center align-items-center">
                    <div className="col">
                        <div className="about-left">
                        <div className="about-thumb">
                            <img src="/src/assets/images/about/01.jpg" alt="about img" />
                        </div>
                        <div className="abs-thumb">
                            <img src="/src/assets/images/about/02.jpg" alt="about img" />
                        </div>
